# description: Finetune GLUE task with distributed GPU training.
"""Finetune GLUE task with distributed GPU training.
"""
import argparse
...
from azureml.core.runconfig import MpiConfiguration  # used to set up distributed training
...
if __name__ == "__main__":
    ...
    exp: Experiment = Experiment(ws, "transformers-glue-finetuning-distributed")

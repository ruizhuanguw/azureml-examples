...
if __name__ == "__main__":
    ...
    config = ScriptRunConfig(
        ...
        arguments=[
            ...
            # training args
            "--evaluation_strategy", "steps",  # more frequent evaluation helps HyperDrive
            "--eval_steps", 200,
            "--learning_rate", 2e-5,  # will be overridden by HyperDrive
            "--per_device_train_batch_size", 16,  # will be overridden by HyperDrive
            "--per_device_eval_batch_size", 16,
            "--num_train_epochs", 5,
            "--weight_decay", 0.01,  # will be overridden by HyperDrive
            "--disable_tqdm", True,
        ],
